...
// ConfigError is an error type for configuration validation.
...
const (
	// ErrMissingAuth indicates missing authentication configuration.
	ErrMissingAuth ConfigError = "missing authentication: set GEMINI_API_KEY or GLM_API_KEY environment variable"
)
