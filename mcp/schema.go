...
// ConvertMCPToolToDeclaration converts an MCPTool to a Gemini FunctionDeclaration.
func ConvertMCPToolToDeclaration(tool *MCPTool, prefix string) *genai.FunctionDeclaration {
	if tool == nil {
		return nil
	}
