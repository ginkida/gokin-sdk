...
func (d *Downloader) Download(ctx context.Context, downloadURL string, progress ProgressCallback) (string, error) {
	// Create request
...
func (d *Downloader) DownloadChecksum(ctx context.Context, checksumURL string) (map[string]string, error) {
